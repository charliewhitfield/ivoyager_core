...
## CPU mirrors of the shader math are this class's static methods.[br][br]
##
...
# *****************************************************************************
# Occlusion math. Each method has a GLSL twin in
...
static func get_two_disc_visible_fraction(sun_angular_radius: float,
...
static func get_ring_transmission(profile_image: Image, position: Vector3,
...
func _update_camera_fraction() -> void:
	...
	if rings:
		fraction *= get_ring_transmission(
...
func _get_point_spheroid_fraction(occluder: IVBody, position: Vector3, sun_direction: Vector3,
	...
	return get_spheroid_occlusion_fraction(position, sun_direction,
