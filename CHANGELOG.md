...
* Mouse-over identification of orbit lines and asteroids (IVFragmentIdentifier) looked in the wrong place, or found nothing, whenever the 3D render scale was below 100%, and missed any line or point seen through a transparent draw, such as an atmosphere limb or a ring. See *Mouse picking* in [VISUAL_MODEL.md](VISUAL_MODEL.md).
